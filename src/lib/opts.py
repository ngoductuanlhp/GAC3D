...
class Opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--affine', type=float, default=0.7,
                                 help='probability of applying affine augmentation.')
        ...
        self.parser.add_argument('--dynamic_dim', action='store_true',
                                 help='dynamic switching dimesion: W, L')
        self.parser.add_argument('--axis_head_angle', action='store_true',
    ...
    def parse(self, args=''):
        ...
        opt.results_dir = os.path.join(opt.exp_dir, 'results_uncertain_nll')
